...
<nav class="sticky top-0 z-30 p-4  border-gray-200 rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
...
{navlinks.map((navlink,idx) => (
          <li>
          <a href={navlink.link} class="block py-2 pl-3 pr-4  hover:text-lime-700 rounded md:bg-transparent  md:p-0  md:dark:bg-transparent" aria-current="page">{navlink.name}</a>
        </li>
        ))}</ul>
    </div>
  </div>

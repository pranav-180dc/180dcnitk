...
const WhoAreWe = () => {
  return (
    ...
    <div className='flex flex-col justify-center items-center basis-1/2 subpixel-antialiased text-7xl font-bold text-lime-600'>
      WHO ARE WE?
    </div>
    <div className='h-64 w-2 rounded-xl bg-clip-content bg-gradient-to-b from-lime-600 to-transparent'></div>
    <div className='flex flex-col basis-1/2 pr-28'>

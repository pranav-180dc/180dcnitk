...
function Services() {
  ...
  <div class="text-center mx-10 my-10 px-8 py-8">
    <p class="text-7xl  text-lime-600 font-bold ">SERVICES</p>
  </div>
  <div>
    <div class=" p-8 mr-6 ml-6 grid grid-cols-3 gap-12">
      <div class=" px-2 py-8  bg-lime-500 shadow-2xl shadow-gray-400 rounded-lg ">
        ...
        <p class="text-white p-4 font-bold text-4xl text-center ">Market Entry and Expansion</p>
      ...
      <div class=" px-2 py-8   bg-lime-500 shadow-2xl shadow-gray-400 rounded-lg ">
        ...
        <p class="text-white p-4 font-bold text-4xl text-center ">Marketing and Branding</p>
      ...
      <div class=" px-2 py-8   bg-lime-500 shadow-2xl shadow-gray-400 rounded-lg  ">
        ...
        <p class="text-white p-4 font-bold text-4xl text-center ">Operations Management</p>
      ...
      <div class=" px-2 py-8    bg-lime-500 shadow-2xl shadow-gray-400 rounded-lg">
        ...
        <p class="text-white p-4 font-bold text-4xl text-center ">Search Engine Optimization</p>
      ...
      <div class=" px-2 py-8   bg-lime-500 shadow-2xl shadow-gray-400 rounded-lg">
        ...
        <p class="text-white p-4 font-bold text-4xl text-center ">Financial Management</p>

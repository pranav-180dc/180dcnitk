    ...
    return (
      ...
      <div className="md:hidden flex flex-wrap justify-around p-3">
        ...
        <FadeInSection>
          <div className="hidden md:flex  md:flex-row md:justify-center md:item-center  md:text-center ">
        {profiles.map((profile, idx) => (
      <div className="text-lime-500 bg-slate-200 border-2 border-lime-500  hover:scale-[1.05] transition-all delay-150  bg-opacity-25 mx-9 rounded-lg  shadow dark:bg-gray-800 dark:border-gray-700">
          <img class="rounded-t-lg" src={profile.imgUrl} alt="" />
            ...
            {consultants.map((consultant, idx) => (
              <div className=" flex flex-col  justify-center items-center  p-12">
                <div className="flex justify-center items-center h-40 w-45 rounded-full bg-lime-600 object-center object-cover shadow-2xl">
                  <img src={consultant.imgUrl} alt="..." className="border-2 border-lime-300  hover:scale-[1.05] transition-all delay-150 h-40 w-40 rounded-full object-cover" />
                </div>
                <div className="flex justify-center items-center text-center text-black opacity-60 font-semibold text-2xl">
                  {consultant.member}
                </div>
            ...
            {Designers.map((Designer, idx) => (
              <div className="flex flex-col  justify-center items-center p-12">
                <div className="flex justify-center items-center h-40 w-40 hover:scale-[1.05] transition-all delay-150 rounded-full bg-lime-600 border border-stone-300 object-center object-cover shadow-2xl">
                  <img src={Designer.imgUrl} alt="..." className="border-2 border-lime-300  h-40 w-40 rounded-full object-left-top object-cover" />
                </div>
            ...
            {Developers.map((Developer, idx) => (
              <div className="flex flex-col   justify-center items-center p-12">
                <div className="flex justify-center items-center h-40 w-40 rounded-full bg-lime-600  object-center object-cover shadow-2xl">
                  <img src={Developer.imgUrl} alt="..." className="h-40 w-40 border-2 border-lime-300  hover:scale-[1.05] transition-all delay-150 rounded-full object-left-top object-cover" />
                </div>
                <div className="flex justify-center items-center text-black opacity-60 font-semibold text-2xl">
                  {Developer.member}
                </div>

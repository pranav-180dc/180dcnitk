...
export default function Team() {
    return (
      <div id="team">
        ...
        <FadeInSection>
          <div className="flex flex-col md:flex-row justify-center item-center sm:basis-full  md:basis-1/4">
        {profiles.map((profile, idx) => (
      <div className="max-w-sm bg-white border h-[400] border-gray-200  shadow dark:bg-gray-800 dark:border-gray-700">
      
          <img class="rounded-t-lg" src={profile.imgUrl} alt="" />

      
      <div class="p-5 text-lime-500 bg-slate-300">
        ...
        <div className="flex flex-col justify-center items-center text-center ">
          <FadeInSection>
            <div className="text-lime-600 p-8 md:p-12 text-4xl text-6xl font-bold">
              Consultants
            </div>
          </FadeInSection>
            <div className="invisible sm:visible h-2 w-64 md:w-96 rounded-xl bg-clip-content bg-gradient-to-r from-lime-600 to-transparent"></div>
        ...
        <div className="flex flex-col justify-center items-center text-center ">
          <FadeInSection>
            <div className="text-lime-600 p-8 md:p-12 text-6xl font-bold">
              Designers
            </div>
          </FadeInSection>
            <div className="invisible sm:visible h-2 w-64 md:w-96 rounded-xl bg-clip-content bg-gradient-to-r from-lime-600 to-transparent"></div>
